...
class Predictor:
    ...
    def _predict_explanation(self, problem: Problem):
        model_input = self.input_encoder_1.encode_input(problem, None)
    ...
    def _predict_answer(self, problem: Problem):
        model_input = self.input_encoder_2.encode_input(problem, None)
    ...
    def predict(self, problem) -> Tuple[str, str]:
        explanation = self._predict_explanation(problem)
        problem.solution = explanation
        answer = self._predict_answer(problem)
...
if __name__ == '__main__':
    ...
    _answer, _explanation = predictor.predict(p)
    print(f'{_answer}\n{_explanation}')
